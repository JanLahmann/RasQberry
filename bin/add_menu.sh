...
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t</Menu> <!-- End HD Demos -->' ~/../../etc/xdg/menus/lxde-pi-applications.menu
...
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t\t\t<Category>HDDemos</Category>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t\t<And>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t<Include>' ~/../../etc/xdg/menus/lxde-pi-applications.menu  
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t<Directory>hd_demos.directory</Directory>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
...
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t</Include>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t\t</And>' ~/../../etc/xdg/menus/lxde-pi-applications.menu 
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t\t\t<Category>Demos</Category>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t\t<And>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t<Include>' ~/../../etc/xdg/menus/lxde-pi-applications.menu  
sudo sed -i '/<\/Menu> <!-- End Other -->/a \\t\t\t<Directory>demos.directory</Directory>' ~/../../etc/xdg/menus/lxde-pi-applications.menu
