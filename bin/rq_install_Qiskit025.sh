...
pip3 install --prefer-binary numpy==1.20.1 scipy==1.5 decorator==4.4.* sympy==1.7.1 retworkx==0.8.0
pip3 install --prefer-binary jupyter_core==4.6.1 matplotlib==3.3 traitlets==5.0
