#!/bin/bash
#
# installation of Qiskit 0.25.4
#

export STARTDATE=`date`
echo; echo; echo "Install Qiskit 0.25.4"; echo;

LLVM_CONFIG=llvm-config-9 pip3 install llvmlite
pip3 install --prefer-binary -U Pillow
pip3 install --prefer-binary numpy==1.20.1 scipy==1.6.1 decorator==4.4.* sympy==1.7.1
...
pip3 install --no-warn-script-location --prefer-binary 'qiskit[all]==0.25.4'
